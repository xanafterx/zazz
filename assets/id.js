...
setData("Kacper", params.get("name").toUpperCase());
setData("Walczuk", params.get("surname").toUpperCase());
setData("Polskie", params.get("nationality").toUpperCase());
setData("02.07.2007", birthday);
